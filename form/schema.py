...
class Query(graphene.ObjectType):
    form = graphene.Field(FormType, form_id=graphene.ID(required=True), password=graphene.String())
    ...
    def resolve_form(self, info, form_id, password=None):
        try:
            ...
            info.context.form_instance = form  # Store form in context if needed elsewhere
            return form
